...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[92] = {
	...
	{(const void *)0x80047af, (ISR)0x8000e1d}, /* 6 */
	{(const void *)0x80047ad, (ISR)0x8000e1d}, /* 7 */
	{(const void *)0x80047ab, (ISR)0x8000e1d}, /* 8 */
	{(const void *)0x80047a9, (ISR)0x8000e1d}, /* 9 */
	{(const void *)0x80047a7, (ISR)0x8000e1d}, /* 10 */
	...
	{(const void *)0x80047a5, (ISR)0x8000e1d}, /* 23 */
	...
	{(const void *)0x80047a3, (ISR)0x8000e1d}, /* 40 */
