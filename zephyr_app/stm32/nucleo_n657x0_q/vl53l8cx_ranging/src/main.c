 ...
 *
 * Target: STM32 Nucleo-N657X0-Q with X-NUCLEO-53L8A1 Shield
                                  ...
                                  const struct sensor_value *center_dist)
{
	...
	printf("    Target: Nucleo-N657X0-Q | Sensor Subsystem Driver Module     \n");
	printf("=================================================================\n\n");
...
int main(void)
{
	...
	printf("\n\n==================================================\n");
	printf("*** STM32N657X0-Q VL53L8CX Sensor Application ***\n");
	printf("==================================================\n");
	fflush(stdout);
